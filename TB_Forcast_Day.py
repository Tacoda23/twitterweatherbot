...
def get_observation(API_key, city, state, unitGroup):
   ...
   # 8:00 CT weather conditions
    global temp1 
    temp1 = response['days'][0]['hours'][8]['temp']
...
body = f"""
Good Morning! Here's what today's looking like:
Now     {icon2}  {condition1} and {temp1}°F
11:00a  {icon4}  {condition2} and {temp2}°F
1:00p   {icon6}  {condition3} and {temp3}°F
3:00p   {icon8}  {condition4} and {temp4}°F
"""
#print (body)
